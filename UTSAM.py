...
st.markdown(
    ...
    <div style="text-align: center;">
        <img src="https://raw.githubusercontent.com/naaufald/UTS_ANALISISMULTIVARIAT/main/tabel%201.png" width="500">
        <p><em>Tabel 1</em></p>
    </div>
    """,
    unsafe_allow_html=True
...
st.markdown(
    """
    <div style="text-align: center;">
        Sumber data: <a href="https://www.bps.go.id/id/statistics-table/2/MjA1IzI=/jumlah-desa-yang-memiliki-fasilitas-sekolah-menurut-provinsi-dan-tingkat-pendidikan.html" target="_blank">Data BPS</a>
    </div>
    """,
    unsafe_allow_html=True
)
...
st.markdown(
    """
    <div style="text-align: center;">
        <img src="https://raw.githubusercontent.com/naaufald/UTS_ANALISISMULTIVARIAT/main/tabel2.png" width="500">
        <p><em>Tabel 2</em></p>
    </div>
    """,
    unsafe_allow_html=True
...
st.markdown(
    """
    <div style="text-align: center;">
        <img src="https://raw.githubusercontent.com/naaufald/UTS_ANALISISMULTIVARIAT/main/CAtab1.png" width="500">
        <p><em>summary</em></p>
    </div>
    """,
    unsafe_allow_html=True
...
st.markdown(
    """
    <div style="text-align: center;">
        <img src="https://raw.githubusercontent.com/naaufald/UTS_ANALISISMULTIVARIAT/main/plot.png" width="500">
        <p><em>plot CA</em></p>
    </div>
    """,
    unsafe_allow_html=True
...
st.markdown(
    """
    <div style="text-align: center;">
        <img src="https://raw.githubusercontent.com/naaufald/UTS_ANALISISMULTIVARIAT/main/CATable2.png" width="500">
        <p><em>CA</em></p>
    </div>
    """,
    unsafe_allow_html=True
...
st.markdown(
    """
    <div style="text-align: center;">
        <img src="https://raw.githubusercontent.com/naaufald/UTS_ANALISISMULTIVARIAT/main/plottab2.png" width="500">
        <p><em>plot CA</em></p>
    </div>
    """,
    unsafe_allow_html=True
